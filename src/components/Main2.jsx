  ...
  return (
    <main className="bg-gradient-to-tr tracking-tight overflow-x-hidden font-Raleway h-[100vh] from-slate-800 to-black text-white border-t">
      <div className="h-full overflow-y-hidden">
        <h1 className="text-3xl max-sm:text-4xl pb-2 md:text-4xl lg:text-5xl xl:text-7xl mt-2 2xl:absolute right-0 left-0 2xl:text-8xla text-center overflow-y-hidden">
          How did I start coding?
        </h1>
        <div className="max-sm:text-center h-full grid 2xl:grid-flow-col items-center">
          <h2 className="text-center 2xl:text-lg max-xl:text-sm mx-auto max-sm:px-5 mt-3 max-w-2xl">
            ...
            press "horn" button and open the gate of my house, thanks to the
            codes I had written!
            <br></br>
            <br></br>
